...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 26, 2024 lúc 10:58 AM
...
(17, 'thuat', 'Vo', '123a duong 10', 123456789, '2024-04-26', '2024-04-26', 923781378, 'Haiti  ', 'None', 2, 0, 'Single', 106, 100, 10, 110),
(18, 'Duy', 'Nguyen', '123A', 123456789, '2024-04-26', '2024-04-26', 1343536364, 'Albania  ', 'None', 2, 0, 'Luxury', 103, 500, 10, 510),
(19, 'Vu', 'Hoang', '123A', 123467890, '2024-04-26', '2024-04-26', 947487356, 'Afghanistan  ', 'None', 2, 0, 'Double', 102, 200, 1, 201);
...
(28, 'Dung', 'Nguyen', '123A', 123456789, '2024-04-26', 946356245, 'Afghanistan  ', 'None', 2, 0, 'Single', 206, 100, 10, 110),
(31, 'Hoang', 'Vo', '123A', 123456789, '2024-04-26', 232464654435, 'Cuba  ', 'None', 2, 0, 'Delux', 104, 1000, 10, 1010);
...
--
ALTER TABLE `checkout`
  ADD CONSTRAINT `fk_room_checkout` FOREIGN KEY (`room_no`) REFERENCES `room` (`room_number`);

--
-- Các ràng buộc cho bảng `guests`
--
ALTER TABLE `guests`
  ADD CONSTRAINT `fk_room_guests` FOREIGN KEY (`room_no`) REFERENCES `room` (`room_number`);
COMMIT;
